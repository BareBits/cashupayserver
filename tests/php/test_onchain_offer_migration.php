...
// A fresh install has the newest marker artifact (the invoices.strike_invoice_id
// column) AND the older migration artifacts.
assert_true(has_col('invoices', 'strike_invoice_id'), 'fresh install has the current marker column');
...
assert_false(has_col('invoices', 'strike_invoice_id'), 'pre-merge: marker column dropped');
...
assert_true(has_col('invoices', 'strike_invoice_id'), 'getInstance() self-heals the marker column');
...
assert_true(has_col('invoices', 'strike_invoice_id'), 're-run leaves the marker column in place');
